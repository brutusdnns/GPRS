package com.example.dennis.st_john;
/**
 * Created by DENNIS on 1/10/2019.
 */
...
public class MainActivity extends BaseActivity {
    ...
    // Database
    final ThreadLocal<DBHelper> dbHelper = new ThreadLocal<>();
                ...
                builder_sp.setPositiveButton(getString(R.string.save_btn_txt),
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                dbHelper.set(new DBHelper(MainActivity.this));
                                dbHelper.get().insertMyCoord(lPointName.getText()
                    ...
                    if (uri != null) {
                        ...
                        try {
                            ...
                            if (c != null && c.moveToFirst()) {
                                ...
                                // update saved number
                                dbHelper.set(new DBHelper(MainActivity.this));
                                dbHelper.get().setSlot(0, name, number);
                                dbHelper.get().close();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call the number on the editText

        setContentView(R.layout.activity_main);
        ImageView imageView = (ImageView) findViewById(R.id.imageView);
        final EditText mPhoneNoEt = (EditText) findViewById(R.id.editText1);
        ...
        dbHelper.set(new DBHelper(this));
        showSelectedNumber(dbHelper.get().getSlot(0, "phone"));
        dbHelper.get().close();
    ...
    public void sendSMS_Debug(String lMsg) {
        ...
        if (phoneToSendSMS.equalsIgnoreCase("")) {
            ...
            // update saved number
            dbHelper.set(new DBHelper(MainActivity.this));
            dbHelper.get().setSlot(0, "", phoneToSendSMS);
            dbHelper.get().close();
